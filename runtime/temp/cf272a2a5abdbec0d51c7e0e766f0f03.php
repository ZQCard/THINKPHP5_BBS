<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\wamp64\www\bbs\public/../application/admin\view\module\index.html";i:1506039767;s:62:"D:\wamp64\www\bbs\public/../application/admin\view\layout.html";i:1506039767;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="fixed-table-body">
                                <table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="name" tabindex="0">
                                            <div class="th-inner ">模块名称</div>
                                            <div class="fht-cell"></div>
                                        </th>
                                        <th data-field="name" tabindex="0">
                                            <div class="th-inner ">模块图标</div>
                                            <div class="fht-cell"></div>
                                        </th>
                                    ...
                                    <tbody>
                                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$module): ?>
                                    <tr class="no-records-found">
                                        <td><?php echo $key+1; ?></td>
                                        <td><?php echo $module['name']; ?></td>
                                        <td>
                                            <img src="<?php echo $module['pic']; ?>" alt="" style="height: 80px;width: 80px;">
                                        </td>
                                        <td><?php echo $module['sort']; ?></td>
                                        <td><?php echo $module['post_num']; ?></td>
                                        <td>
                                            <div class="switch">
                                                <div class="onoffswitch">
                                                    <input type="checkbox" <?php if($module['status'] == '1'): ?>checked=""<?php endif; ?>  class="onoffswitch-checkbox statusChange" id="status-<?php echo $module['status']; ?>-<?php echo $module['id']; ?>">
                                                    <label class="onoffswitch-label" for="status-<?php echo $module['status']; ?>-<?php echo $module['id']; ?>">
                                        ...
                                        <td><?php echo $module['is_del']; ?></td>
                                        <td><?php echo date("Y-m-d",$module['update_time']); ?></td>
                                        <td><?php echo date("Y-m-d",$module['create_time']); ?></td>

                                        <td>
                                            <a href="<?php echo url('admin/module/edit',['id'=>$module['id']]); ?>" type="button" class="btn btn-outline btn-default"  title="修改">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a type="button" class="btn btn-outline btn-default delete" data-id="<?php echo $module['id']; ?>" data-name="<?php echo $module['name']; ?>" data-type="2"  title="删除">
