<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp64\www\bbs\public/../application/admin\view\module\edit.html";i:1506039767;s:62:"D:\wamp64\www\bbs\public/../application/admin\view\layout.html";i:1506733112;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" action="<?php echo url('update'); ?>" id="commentForm" novalidate="novalidate">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="<?php echo $data_view['sort']; ?>" class="form-control" name="sort" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="pid" id="" style="height: 30px;">
                                    ...
                                    <?php if(is_array($firstModel) || $firstModel instanceof \think\Collection || $firstModel instanceof \think\Paginator): if( count($firstModel)==0 ) : echo "" ;else: foreach($firstModel as $key=>$fmodule): ?>
                                        <option value="<?php echo $fmodule['id']; ?>" <?php if($data_view['pid'] == $fmodule['id']): ?>selected<?php endif; ?>><?php echo $fmodule['name']; ?></option>
