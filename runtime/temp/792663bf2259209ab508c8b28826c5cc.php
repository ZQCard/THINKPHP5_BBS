<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp64\www\bbs\public/../application/index\view\index\index.html";i:1506063144;s:62:"D:\wamp64\www\bbs\public/../application/index\view\layout.html";i:1506067513;}*/ ?>
<html>
<head>
                                    ...
                                    <ul class="recommend-list">
                                        <li class="qr-trigger">
                                            <?php if(is_array($newsInfo) || $newsInfo instanceof \think\Collection || $newsInfo instanceof \think\Paginator): if( count($newsInfo)==0 ) : echo "" ;else: foreach($newsInfo as $key=>$news): ?>
                                                <?php echo $news; endforeach; endif; else: echo "" ;endif; ?>
                                        </li>
                                    </ul>
                                </div>
                            </div>
