<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp64\www\bbs\public/../application/admin\view\banner\edit.html";i:1505040630;s:62:"D:\wamp64\www\bbs\public/../application/admin\view\layout.html";i:1505634617;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo url('admin/module/index'); ?>">论坛分类管理</a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" action="<?php echo url('update'); ?>" id="commentForm" novalidate="novalidate">
                        <input type="hidden" name="__token__" value="<?php echo \think\Request::instance()->token(); ?>" />
                        <div class="form-group">
                            <label class="col-sm-3 control-label">轮播图名称：</label>
                            <div class="col-sm-8">
                                <input name="name" value="<?php echo $data_view['name']; ?>" minlength="2" type="text" class="form-control" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="<?php echo $data_view['link']; ?>" class="form-control" name="link" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">排序值：</label>
                            <div class="col-sm-8">
                                <input type="number" name="sort" maxlength="11" value="<?php echo $data_view['sort']; ?>"  minlength="11" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="start_time" value="<?php echo $data_view['start_time']; ?>" required="" aria-required="true" placeholder="选择日期" onclick="fPopCalendar(event,this,this)" readonly="readonly">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">结束时间：</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="end_time" value="<?php echo $data_view['end_time']; ?>" required="" aria-required="true"  placeholder="选择日期" onclick="fPopCalendar(event,this,this)" readonly="readonly">
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    <script>
        $(document).ready(function() {
            var url = "<?php echo url('admin/common/upload',['type' => 'banner']); ?>";
