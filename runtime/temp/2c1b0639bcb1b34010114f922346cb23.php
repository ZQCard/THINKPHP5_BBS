<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\wamp64\www\bbs\public/../application/admin\view\category\index.html";i:1505039641;s:62:"D:\wamp64\www\bbs\public/../application/admin\view\layout.html";i:1505650129;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="example">
                    ...
                    <div class="bootstrap-table">
                        <div class="fixed-table-toolbar"><div class="bars pull-left"><div class="btn-group hidden-xs" id="exampleToolbar" role="group">
                            <a type="button"  href="<?php echo url('create'); ?>" class="btn btn-outline btn-default"  title="添加导航">
                        ...
                        <div class="fixed-table-container" style="padding-bottom: 0px;">
                            ...
                            <div class="fixed-table-body">
                                <table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover">
                                    ...
                                    <tbody>
                                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$category): ?>
                                    <tr class="no-records-found">
                                        ...
                                        <td>
                                            <div class="switch">
                                                <div class="onoffswitch">
                                                    <input type="checkbox" <?php if($category->status == '正常'): ?>checked=""<?php endif; ?>  class="onoffswitch-checkbox statusChange" id="status-<?php echo $category->status; ?>-<?php echo $category->id; ?>">
                                                    <label class="onoffswitch-label" for="status-<?php echo $category->status; ?>-<?php echo $category->id; ?>">
                                        ...
                                        <td><?php echo $category->update_time; ?></td>
                                        <td><?php echo $category->create_time; ?></td>

                                        <td>
                                            <a href="<?php echo url('admin/category/edit',['id'=>$category->id]); ?>" type="button" class="btn btn-outline btn-default"  title="修改">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a type="button" class="btn btn-outline btn-default delete" data-id="<?php echo $category->id; ?>" data-name="<?php echo $category->name; ?>"  title="删除">
