<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\wamp64\www\bbs\public/../application/admin\view\banner\index.html";i:1506039767;s:62:"D:\wamp64\www\bbs\public/../application/admin\view\layout.html";i:1506300485;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="row J_mainContent" id="content-main">
        <div class="col-sm-12">
            ...
            <div class="example-wrap">
                <h4 class="example-title">轮播图管理&nbsp;&nbsp;&nbsp;当前共显示（<?php echo $num; ?>）个</h4>
                <div class="example">
                            ...
                            <div class="fixed-table-body">
                                <table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="name" tabindex="0">
                                            <div class="th-inner ">轮播图名称</div>
                                            <div class="fht-cell"></div>
                                        </th>
                                        <th data-field="name" tabindex="0">
                                            <div class="th-inner ">轮播图</div>
                                            <div class="fht-cell"></div>
                                        </th>
                                        ...
                                        <th style="" data-field="name" tabindex="0">
                                            <div class="th-inner ">开启时间</div>
                                            <div class="fht-cell"></div>
                                        </th>
                                        <th style="" data-field="name" tabindex="0">
                                            <div class="th-inner ">关闭时间</div>
                                            <div class="fht-cell"></div>
                                        </th>
                                        <th style="" data-field="name" tabindex="0">
                                    ...
                                    <tbody>
                                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$banner): ?>
                                    <tr class="no-records-found">
                                        <td><?php echo $key+1; ?></td>
                                        <td><?php echo $banner->name; ?></td>
                                        <td>
                                            <img src="<?php echo $banner->pic; ?>" height="80px;" width="80px;" alt="<?php echo $banner->name; ?>">
                                        </td>
                                        <td><?php echo $banner->sort; ?></td>
                                        <td><?php echo $banner->link; ?></td>
                                        <td><?php echo $banner->start_time; ?></td>
                                        <td><?php echo $banner->end_time; ?></td>
                                        <td>
                                            <div class="switch">
                                                <div class="onoffswitch">
                                                    <input type="checkbox" <?php if($banner->status == '正常'): ?>checked=""<?php endif; ?>  class="onoffswitch-checkbox statusChange" id="status-<?php echo $banner->status; ?>-<?php echo $banner->id; ?>">
                                                    <label class="onoffswitch-label" for="status-<?php echo $banner->status; ?>-<?php echo $banner->id; ?>">
                                        ...
                                        <td><?php echo $banner->update_time; ?></td>
                                        <td><?php echo $banner->create_time; ?></td>

                                        <td>
                                            <a href="<?php echo url('admin/banner/edit',['id'=>$banner->id]); ?>" type="button" class="btn btn-outline btn-default"  title="修改">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a type="button" class="btn btn-outline btn-default delete" data-id="<?php echo $banner->id; ?>" data-name="<?php echo $banner->name; ?>"  title="删除">
