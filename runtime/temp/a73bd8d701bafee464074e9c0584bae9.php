<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\wamp64\www\bbs\public/../application/admin\view\link\check.html";i:1505634770;s:62:"D:\wamp64\www\bbs\public/../application/admin\view\layout.html";i:1505650129;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="row J_mainContent" id="content-main">
        <div class="col-sm-12">
            ...
            <div class="example-wrap">
                <h4 class="example-title">友情链接管理&nbsp;&nbsp;&nbsp;当前共显示（<?php echo $num; ?>）个</h4>
                <div class="example">
                        ...
                        <div class="fixed-table-container" style="padding-bottom: 0px;">
                            ...
                            <div class="fixed-table-body">
                                <table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover">
                                    ...
                                    <tbody>
                                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$link): ?>
                                    <tr class="no-records-found">
                                        <td><?php echo $key+1; ?></td>
                                        <td><?php echo $link->name; ?></td>
                                        <td><?php echo $link->link; ?></td>
                                        <td><?php echo $link->sort; ?></td>
                                        <td><?php echo $link->start_time; ?></td>
                                        <td><?php echo $link->end_time; ?></td>
                                        <td>
                                            <div class="switch">
                                                <div class="onoffswitch">
                                                    <input type="checkbox" <?php if($link->status == '正常'): ?>checked=""<?php endif; ?>  class="onoffswitch-checkbox statusChange" id="status-<?php echo $link->status; ?>-<?php echo $link->id; ?>">
                                                    <label class="onoffswitch-label" for="status-<?php echo $link->status; ?>-<?php echo $link->id; ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo url('admin/link/edit',['id'=>$link->id]); ?>" type="button" class="btn btn-outline btn-default"  title="修改">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a type="button" class="btn btn-outline btn-default delete" data-id="<?php echo $link->id; ?>" data-name="<?php echo $link->name; ?>"  title="删除">
