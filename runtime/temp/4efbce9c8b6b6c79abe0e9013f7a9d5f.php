<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp64\www\bbs\public/../application/admin\view\index\index.html";i:1505653448;s:62:"D:\wamp64\www\bbs\public/../application/admin\view\layout.html";i:1505748834;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <ul class="nav navbar-top-links navbar-right">
                    <button class="btn-primary" id="quit">退出</button>
                    <li class="dropdown">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" id="linkOrder" href="javascript:;">
...
<script>
    $("#quit").click(function () {
        var url = "<?php echo url('admin/index/logout'); ?>";
