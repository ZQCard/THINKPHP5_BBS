<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\wamp64\www\bbs\public/../application/admin\view\administrator\edit.html";i:1505041188;s:62:"D:\wamp64\www\bbs\public/../application/admin\view\layout.html";i:1505041200;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" action="<?php echo url('update'); ?>" id="commentForm" novalidate="novalidate">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input name="username" readonly="true" value="<?php echo $data_view['username']; ?>" minlength="2" type="text" class="form-control" required="" aria-required="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number"maxlength="11" value="<?php echo $data_view['phone']; ?>"  minlength="11" class="form-control" required name="phone">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">身份：</label>
                            <div class="col-sm-8">
                                <select name="auth_id" style="height: 30px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="switch">
                                    <div class="onoffswitch">
                                        <input type="checkbox" <?php if($data_view['is_del'] == '2'): ?>checked=""<?php endif; ?> class="onoffswitch-checkbox" name="is_del" id="example3">
